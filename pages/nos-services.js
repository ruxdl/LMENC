        ...
        <h2>Nos Prestations</h2>
         ...
         <section className="big-services">
          <article className="service-large">
            ...
            <Link
              href="/nos-services/renovations-de-malles"
          ...
          <article className="service-large">
            <img
              src="assets/img/service-creation.png"
              alt="Créations de malles"
            />
            <h3>Créations de malles</h3>
            <p>
              Conceptions sur-mesure et réalisations artisanales pour créer des
              malles uniques.
            </p>
            <Link
              href="/nos-services/creations-de-malles"
              className="btn-secondary"
            >
              En savoir plus
            </Link>
          ...
          <article className="service-large">
            <img
              src="assets/img/service-vente.png"
            ...
            <Link
              href="/nos-services/ventes-de-malles"
              className="btn-secondary"
            >
              En savoir plus
            </Link>
