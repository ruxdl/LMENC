      ...
      <div className="footer-bandeau container">
        <div className="footer-col socials">
          ...
          <ul className="social-icons">
            <li>
              <a href="https://www.instagram.com/lamalleencoin67500?igsh=dW04OHZrOThja3h0" target="_blank" rel="noopener" aria-label="Instagram">
            ...
            <li>
              <a href="https://www.facebook.com/share/1B8hmw5WRR/?mibextid=wwXIfr" target="_blank" rel="noopener" aria-label="Facebook">
            ...
            <li>
              <a href="https://pin.it/4Ch20JE0E" target="_blank" rel="noopener" aria-label="Pinterest">
            ...
            <li>
              <a href="https://www.youtube.com/@malleencoin" target="_blank" rel="noopener" aria-label="YouTube">
